...
function renderHtaccess() {
  ...
  const csp = [
    ...
    "font-src 'self'",
    "img-src 'self' data: blob: https://media.cricheroes.in https://gtgaming.shop https://www.google-analytics.com https://pagead2.googlesyndication.com https://googleads.g.doubleclick.net https://tpc.googlesyndication.com",
